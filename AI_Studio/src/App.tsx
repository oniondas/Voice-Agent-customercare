        ...
        <div className="flex h-screen bg-slate-50">
            ...
            <div className="flex-1 flex flex-col h-full relative">
                ...
                <div className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 shadow-sm z-10">
                    ...
                    {/* Demo Mode Badge */}
                    {isDemoMode && (
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-yellow-400 text-yellow-900 text-[10px] font-bold px-3 py-1 rounded-b-lg shadow-sm animate-pulse z-50 uppercase tracking-widest">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className={`p-2 rounded-lg transition-colors ${isDemoMode ? 'text-yellow-600 bg-yellow-50' : 'text-slate-400 hover:text-slate-600'}`}
